...
module final_soc_mm_interconnect_0 (
		...
		input  wire        VGA_Controller_0_RESET_reset_bridge_in_reset_reset, // VGA_Controller_0_RESET_reset_bridge_in_reset.reset
	...
	wire          rsp_mux_src_valid;                                                              // rsp_mux:src_valid -> VGA_Controller_0_VGA_MASTER_agent:rp_valid
	wire  [107:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> VGA_Controller_0_VGA_MASTER_agent:rp_data
	wire          rsp_mux_src_ready;                                                              // VGA_Controller_0_VGA_MASTER_agent:rp_ready -> rsp_mux:src_ready
	wire    [5:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> VGA_Controller_0_VGA_MASTER_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                      // rsp_mux:src_startofpacket -> VGA_Controller_0_VGA_MASTER_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                        // rsp_mux:src_endofpacket -> VGA_Controller_0_VGA_MASTER_agent:rp_endofpacket
	...
	wire    [5:0] rsp_mux_002_src_channel;                                                        // rsp_mux_002:src_channel -> NIOS2_instruction_master_agent:rp_channel
	...
	wire    [5:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> SDRAM_s1_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                                          // cmd_mux_001:src_valid -> VGA_Controller_0_VGA_SLAVE_1_agent:cp_valid
	wire  [107:0] cmd_mux_001_src_data;                                                           // cmd_mux_001:src_data -> VGA_Controller_0_VGA_SLAVE_1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                          // VGA_Controller_0_VGA_SLAVE_1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> VGA_Controller_0_VGA_SLAVE_1_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                  // cmd_mux_001:src_startofpacket -> VGA_Controller_0_VGA_SLAVE_1_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                    // cmd_mux_001:src_endofpacket -> VGA_Controller_0_VGA_SLAVE_1_agent:cp_endofpacket
	...
	wire  [107:0] cmd_mux_003_src_data;                                                           // cmd_mux_003:src_data -> NIOS2_debug_mem_slave_agent:cp_data
	...
	wire  [107:0] cmd_mux_004_src_data;                                                           // cmd_mux_004:src_data -> PLL_pll_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                          // PLL_pll_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                        // cmd_mux_004:src_channel -> PLL_pll_slave_agent:cp_channel
	...
	wire          vga_controller_0_vga_master_agent_cp_valid;                                     // VGA_Controller_0_VGA_MASTER_agent:cp_valid -> router:sink_valid
	wire  [107:0] vga_controller_0_vga_master_agent_cp_data;                                      // VGA_Controller_0_VGA_MASTER_agent:cp_data -> router:sink_data
	wire          vga_controller_0_vga_master_agent_cp_ready;                                     // router:sink_ready -> VGA_Controller_0_VGA_MASTER_agent:cp_ready
	wire          vga_controller_0_vga_master_agent_cp_startofpacket;                             // VGA_Controller_0_VGA_MASTER_agent:cp_startofpacket -> router:sink_startofpacket
	wire          vga_controller_0_vga_master_agent_cp_endofpacket;                               // VGA_Controller_0_VGA_MASTER_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [107:0] sdram_s1_agent_rp_data;                                                         // SDRAM_s1_agent:rp_data -> router_003:sink_data
	...
	wire          vga_controller_0_vga_slave_1_agent_rp_valid;                                    // VGA_Controller_0_VGA_SLAVE_1_agent:rp_valid -> router_004:sink_valid
	wire  [107:0] vga_controller_0_vga_slave_1_agent_rp_data;                                     // VGA_Controller_0_VGA_SLAVE_1_agent:rp_data -> router_004:sink_data
	wire          vga_controller_0_vga_slave_1_agent_rp_ready;                                    // router_004:sink_ready -> VGA_Controller_0_VGA_SLAVE_1_agent:rp_ready
	wire          vga_controller_0_vga_slave_1_agent_rp_startofpacket;                            // VGA_Controller_0_VGA_SLAVE_1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          vga_controller_0_vga_slave_1_agent_rp_endofpacket;                              // VGA_Controller_0_VGA_SLAVE_1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [107:0] nios2_debug_mem_slave_agent_rp_data;                                            // NIOS2_debug_mem_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [107:0] pll_pll_slave_agent_rp_data;                                                    // PLL_pll_slave_agent:rp_data -> router_007:sink_data
	...
	wire  [107:0] timer_0_s1_agent_rp_data;                                                       // timer_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire          vga_controller_0_vga_slave_1_agent_rdata_fifo_src_valid;                        // VGA_Controller_0_VGA_SLAVE_1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] vga_controller_0_vga_slave_1_agent_rdata_fifo_src_data;                         // VGA_Controller_0_VGA_SLAVE_1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          vga_controller_0_vga_slave_1_agent_rdata_fifo_src_ready;                        // avalon_st_adapter_001:in_0_ready -> VGA_Controller_0_VGA_SLAVE_1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                              // avalon_st_adapter_001:out_0_valid -> VGA_Controller_0_VGA_SLAVE_1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                               // avalon_st_adapter_001:out_0_data -> VGA_Controller_0_VGA_SLAVE_1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                              // VGA_Controller_0_VGA_SLAVE_1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                              // avalon_st_adapter_001:out_0_error -> VGA_Controller_0_VGA_SLAVE_1_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_translator #(
		...
		.reset                  (VGA_Controller_0_RESET_reset_bridge_in_reset_reset),                             //                     reset.reset
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                                                  //       clk.clk
		.reset                 (VGA_Controller_0_RESET_reset_bridge_in_reset_reset),                             // clk_reset.reset
	...
	final_soc_mm_interconnect_0_router_001 router_002 (
	...
	final_soc_mm_interconnect_0_router_004 router_006 (
	...
	final_soc_mm_interconnect_0_router_004 router_007 (
	...
	final_soc_mm_interconnect_0_router_004 router_008 (
	...
	final_soc_mm_interconnect_0_cmd_demux_001 cmd_demux_002 (
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (VGA_Controller_0_RESET_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_soc_mm_interconnect_0_rsp_mux_001 rsp_mux_002 (
		.clk                 (clk_0_clk_clk),                                      //       clk.clk
		.reset               (VGA_Controller_0_RESET_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (VGA_Controller_0_RESET_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (VGA_Controller_0_RESET_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	final_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (VGA_Controller_0_RESET_reset_bridge_in_reset_reset),      // in_rst_0.reset
