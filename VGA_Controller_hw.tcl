...
set_interface_property VGA_SLAVE writeWaitStates 1
set_interface_property VGA_SLAVE writeWaitTime 1
...
add_interface_port VGA_SLAVE VGA_ADDR address Input 12
add_interface_port VGA_SLAVE VGA_BYTE_EN byteenable Input 1
add_interface_port VGA_SLAVE VGA_CS chipselect Input 1
add_interface_port VGA_SLAVE VGA_READDATA readdata Output 8
add_interface_port VGA_SLAVE VGA_WRITEDATA writedata Input 8
add_interface_port VGA_SLAVE VGA_READ read Input 1
add_interface_port VGA_SLAVE VGA_WRITE write Input 1
...
set_interface_property VGA_R associatedClock RGB_CLK
...
set_interface_property VGA_G associatedClock RGB_CLK
...
set_interface_property VGA_B associatedClock RGB_CLK
...
# 
add_interface RGB_CLK clock end
set_interface_property RGB_CLK clockRate 75000000
...
add_interface_port RGB_CLK RGB_CLK_clk clk Input 1
